                                    ...
                                    <ul className="navbar-nav m-auto">
                                        ...
                                        <li className="nav-item">
                                            <Link href="#">
                                                <a onClick={e => e.preventDefault()} className="nav-link">
                                                    Forms and Downloads <i className='bx bx-chevron-down'></i>
                                                </a>
                                            </Link>
                                        ...
                                        <li className="nav-item">
                                            ...
                                            <ul className="dropdown-menu">
                                                <li className="nav-item">
                                                    <Link href="#" activeClassName="active">
                                                        <a onClick={toggleNavbar} className="nav-link">Export And Domestic Credit Insurance</a>
                                                    </Link>
                                                </li>

                                                <li className="nav-item">
                                                    <Link href="#" activeClassName="active">
                                                        <a onClick={toggleNavbar} className="nav-link">Bonds And Financial Guarantees</a>
                                                    </Link>
                                                </li>

                                                <li className="nav-item">
                                                    <Link href="#" activeClassName="active">
                                                        <a onClick={toggleNavbar} className="nav-link">MSME Credit and Financial Guarantees</a>
                                                    </Link>
                                                </li>
                                                <li className="nav-item">
                                                    <Link href="#" activeClassName="active">
                                                        <a onClick={toggleNavbar} className="nav-link">General Insurance</a>
                                                    </Link>
                                                </li>
                                            </ul>
                                        </li>
